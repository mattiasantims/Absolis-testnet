...
export function downloadCommitmentPDF(c, txHash, merchantProfile = null) {
  ...
  addDisclaimer(270)
  doc.save(`absolis_commitment_${(c.ref || c.commitmentId).replace(/[^a-zA-Z0-9-_]/g, '_')}.pdf`)
}
...
export function downloadFulfillPDF(c, txHash, trancheIndex = null, merchantProfile = null) {
  ...
  doc.save(`absolis_${suffix}_${(c.ref || c.commitmentId).replace(/[^a-zA-Z0-9-_]/g, '_')}.pdf`)
}
...
export function downloadCancelPDF(c, txHash, merchantProfile = null) {
  ...
  addDisclaimer(270)
  doc.save(`absolis_cancelled_${(c.ref || c.commitmentId).replace(/[^a-zA-Z0-9-_]/g, '_')}.pdf`)
}
...
export function downloadRefundPDF(c, refund, txHash, merchantProfile = null) {
  ...
  addDisclaimer(270)
  doc.save(`absolis_refund_${(c.ref || c.commitmentId).replace(/[^a-zA-Z0-9-_]/g, '_')}.pdf`)
}
...
export function downloadFullCommitmentPDF(c, events = [], merchantProfile = null) {
  ...
  addDivider()
  addField('Receipt URL', `https://absolis-testnet.vercel.app/commitment/${c.commitmentId}`)
  ...
  doc.text(`Generated by Absolis v0.1 · ${new Date().toISOString()}`, margin, 272 + disc.length * 4 + 2)

  doc.save(`absolis_full_${(c.ref || c.commitmentId).replace(/[^a-zA-Z0-9-_]/g, '_')}.pdf`)
}
