    ...
    <div className="fade-up">
      ...
      <div className="card" style={{ padding: 24, marginBottom: 20 }}>
        ...
        <p style={{ fontSize: 14, color: 'var(--text2)', lineHeight: 1.7, margin: '0 0 16px' }}>
          Absolis is currently a web-based testnet MVP. The roadmap expands toward merchant APIs, webhooks, e-commerce plugins, accounting exports, EURC support and AI-assisted analytics.
        </p>
        <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
          {[
